...
MATLAB code for the phase-analysis of continuous data, including EEG and background unit activity (BUA), to show the relationship between instantaneous phase values and modulation of the continous data in either linear or circular plot.
